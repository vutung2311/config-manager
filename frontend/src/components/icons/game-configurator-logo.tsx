...
export const GameConfiguratorLogoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  props,
) => (
  <svg
...
export const GameConfiguratorLogoText: React.FC<React.SVGProps<SVGSVGElement>> = (
  props,
) => {
  return (
    <svg
      ...
      {...props}
    >
      <text x="0" y="18" font-family="Arial, sans-serif" font-size="18" font-weight="bold" fill="currentColor">GameConfigurator</text>
    </svg>
  );
};
